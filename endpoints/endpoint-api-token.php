...
class BOOSTRZ_API_TOKEN extends ENDPOINT_API {
    ...
    public function __construct($array) {
       parent::__construct(); // Calling the constructor of the parent class
        ...
        $this->body['username'] = isset($_POST['boostrz_username']) ? $_POST['boostrz_username'] : get_option('boostrz_username');
        $this->body['password'] = isset($_POST['boostrz_password']) ? $_POST['boostrz_password'] : get_option('boostrz_password');
